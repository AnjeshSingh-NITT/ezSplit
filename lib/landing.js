...
export const TESTIMONIALS = [
    {
      quote:
        "Ye babu rao ka style hai! With EzSplit, I finally stopped getting confused about who paid for what!",
      name: "Babu Rao",
    ...
    {
      quote:
        "EzSplit's calculations are so accurate, they're even better than my scheme to double money in 25 days!",
      name: "Raju",
    ...
    {
      quote:
        "If I had EzSplit back then, Raju wouldn’t have gotten away with selling my shoes and coat — I’d have added it to his debt!",
      name: "Shyam",
